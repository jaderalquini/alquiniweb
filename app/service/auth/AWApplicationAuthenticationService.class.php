...
class AWApplicationAuthenticationService
{
    /**
    ...
    public static function setUnit($unit_id)
    {
        ...
        if (!empty($ini['general']['multiunit']) and $ini['general']['multiunit'] == '1' and !empty($unit_id))
        {
            ...
            TSession::setValue('userunitlogo', AWSystemUnit::findInTransaction('permission_aux', $unit_id)->logo);
    ...
    public static function loadSessionVars($user)
    {
        ...
        if (!empty($user->unit))
        {
            ...
            TSession::setValue('userunitlogo', AWSystemUnit::findInTransaction('permission_aux', $user->unit->logo));
        }
    }
