<?php
/**
 * TiposResidenciaForm Registration
 * @author  <your name here>
 */
class TiposResidenciaForm extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        ...
        $this->form->setFormTitle(_t('Residence Type'));    
        ...
        $this->form->addActionLink( _t('Back'), new TAction(array('TiposResidenciaList','onReload')),  'far:arrow-alt-circle-left blue' );
        
        // vertical box container
        $container = new TVBox;
        $container->style = 'width: 100%';
        $container->add(new TXMLBreadCrumb('menu.xml', 'TiposResidenciaList'));
