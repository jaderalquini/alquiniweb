 ...
 */
class ProfissoesList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_Profissoes');
        $this->form->setFormTitle(_t('Occupations'));
        ...
        $this->form->setData( TSession::getValue('Profissoes_filter_data') );
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('ProfissoesForm', 'onEdit'), ['register_state' => 'false'] );
