<?php
/**
 * ProfissoesList Listing
 * @author  <your name here>
 */
class ProfissoesList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new TForm('form_search_Profissoes');
        ...
        $action1 = new TDataGridAction(['ProfissoesForm', 'onEdit'], ['id'=>'{id}']);
        ...
        $panel = new TPanelGroup(_t('Occupations'));
        $panel->add($this->form);
        $panel->addFooter($this->pageNavigation);
        
        // header actions
        $panel->addHeaderActionLink( _t('New'),  new TAction(['ProfissoesForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green' );
        ...
        $dropdown->addAction( _t('Save as PDF'), new TAction([$this, 'onExportPDF'], ['title' => _t('Listing of') . ' ' . _t('Occupations'), 'register_state' => 'false', 'static'=>'1']), 'far:file-pdf fa-fw red' );
