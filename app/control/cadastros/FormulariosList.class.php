<?php
/**
 * FormulariosList Listing
 * @author  Jáder Alexandre Alquini
 */
class FormulariosList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('Formularios');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Formularios');
        $this->form->setFormTitle(_t('Forms'));
        ...
        $column_conteudo = new TDataGridColumn('conteudo', _t('Content'), 'left');
        ...
        $column_conteudo->setTransformer(function($value) {
            return $value;
        });;
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('FormulariosForm', 'onEdit'), ['register_state' => 'false'] );
        ...
        $panel->addHeaderActionLink(_t('New'), new TAction(['FormulariosForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
