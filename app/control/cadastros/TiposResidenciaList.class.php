 ...
 */
class TiposResidenciaList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_TiposResidencia');
        $this->form->setFormTitle(_t('Residence Types'));
        ...
        $this->form->setData( TSession::getValue('iposResidencia_filter_data') );
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('TiposResidenciaForm', 'onEdit'), ['register_state' => 'false'] );
