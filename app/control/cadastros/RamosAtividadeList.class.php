<?php
/**
 * RamosAtividadeList Listing
 * @author  <your name here>
 */
class RamosAtividadeList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('RamosAtividade');   // defines the active record
        ...
        $this->form = new TForm('form_search_RamosAtividade');
        ...
        $action1 = new TDataGridAction(['RamosAtividadeForm', 'onEdit'], ['id'=>'{id}']);
        ...
        $panel = new TPanelGroup(_t('Branches of Aactivity'));
        $panel->add($this->form);
        $panel->addFooter($this->pageNavigation);
        
        // header actions
        $panel->addHeaderActionLink( _t('New'),  new TAction(['RamosAtividadeForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green' );
        ...
        $dropdown->addAction( _t('Save as PDF'), new TAction([$this, 'onExportPDF'], ['title' => _t('Listing of') . ' ' . _t('Branches of Aactivity'), 'register_state' => 'false', 'static'=>'1']), 'far:file-pdf fa-fw red' );
