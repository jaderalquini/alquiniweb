 ...
 */
class RamosAtividadeList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder('form_search_RamosAtividade');
        $this->form->setFormTitle(_t('Branches of Aactivity'));
        ...
        $this->form->setData( TSession::getValue('RamosAtividade_filter_data') );
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('RamosAtividadeForm', 'onEdit'), ['register_state' => 'false'] );
