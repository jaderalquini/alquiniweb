<?php
/**
 * HHCursosList Listing
 * @author  <your name here>
 */
class HHCursosList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $this->setOrderCommand('pessoa->nome', '(select nome from pessoas where pessoa_id = id)');
        ...
        $this->form->addFields( [new TLabel(_t('Techer'))], [$pessoa_id] );
        ...
        $column_pessoa_id = new TDataGridColumn('{pessoa->nome}', _t('Teacher'), 'left');
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('HHCursosForm', 'onEdit'), ['register_state' => 'false'] );
        ...
        $panel->addHeaderActionLink(_t('New'), new TAction(['HHCursosForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
