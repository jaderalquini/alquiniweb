<?php
/**
 * FormasPagamentoForm Registration
 * @author  <your name here>
 */
class FormasPagamentoForm extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        ...
        $this->setActiveRecord('FormasPagamento');     // defines the active record

        // creates the form
        $this->form = new BootstrapFormBuilder('form_FormasPagamento');
        $this->form->setFormTitle(_t('Payment Method'));
    ...
    public function onSave()
    {
        try
        {
            ...
            $this->afterSaveAction = new TAction(['FormasPagamentoList', 'onReload']);
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new FormasPagamento($key);
