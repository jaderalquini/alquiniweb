<?php
/**
 * DespesasList Listing
 * @author  Jáder Alexandre Alquini
 */
class DespesasList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $criteria->add(new TFilter('tipo', '=', 'S'));
        ...
        $this->form->setData( TSession::getValue('Despesas_filter_data') );
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('DespesasForm', 'onEdit'), ['register_state' => 'false'] );
        ...
        $panel->addHeaderActionLink(_t('New'), new TAction(['DespesasForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
