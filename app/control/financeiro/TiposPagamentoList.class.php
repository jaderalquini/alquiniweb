<?php
/**
 * TiposPagamentoList Listing
 * @author  Jáder Alexandre Alquini
 */
class TiposPagamentoList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('TiposPagamento');   // defines the active record
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_TiposPagamento');
        $this->form->setFormTitle(_t('Payment Types'));
        ...
        $this->form->setData( TSession::getValue('TiposPagamento_filter_data') );
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('TiposPagamentoForm', 'onEdit'), ['register_state' => 'false'] );
        ...
        $panel->addHeaderActionLink(_t('New'), new TAction(['TiposPagamentoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
