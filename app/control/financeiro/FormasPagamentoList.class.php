<?php
/**
 * FormasPagamentoList Listing
 * @author  Jáder Alexandre Alquini
 */
class FormasPagamentoList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        parent::setActiveRecord('FormasPagamento');   // defines the active record
        ...
        $this->form->setData( TSession::getValue('FormasPagamento_filter_data') );
        ...
        // create EDIT action
        $action_edit = new TDataGridAction(array('FormasPagamentoForm', 'onEdit'), ['register_state' => 'false'] );
        ...
        $panel->addHeaderActionLink(_t('New'), new TAction(['FormasPagamentoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
    ...
    public function deleteSelected()
    {
        ...
        if ($selected_objects)
        {
            ...
            {
                $object = FormasPagamento::find($id);
                if ($object)
                {
                    $object->delete();
                }
