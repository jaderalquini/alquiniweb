...
class ReceitasForm extends TPage
{
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_Receitas');
        $this->form->setFormTitle(_t('Revenue'));
    ...
    public function onSave()
    {
        try
        {
            ...
            $this->afterSaveAction = new TAction(['ReceitasList', 'onReload']);
