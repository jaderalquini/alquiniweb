 ...
 * @license    
 */
class AWLoginForm extends TPage
{
    protected $form; // form
    ...
    function __construct($param)
    {
        ...
        $this->form->setFormTitle( 'Acessar o Sistma' );
        ...
        $user   = '<span class="login-avatar"><span class="fa fa-envelope"></span></span>';
        ...
        $btn = new TButton('entrar');
        $btn->setAction(new TAction(array($this, 'onLogin')));
        $btn->setLabel('Entrar');
        $btn->class = 'btn btn-primary';
        ...
        $link = new TElement('a');
        $link->href = 'index.php?class=AWSystemRequestPasswordResetForm';
        $link->add('Esqueci a Senha');
        ...
        $btn = new TElement('a');
        $btn->href = 'index.php?class=AWSystemRegistrationForm';
        $btn->class = 'btn btn-secondary';
        $btn->style = 'height: 40px; width: 100%; display: block; margin: auto;font-size:17px;';
        $btn->add('Experimete Grátis');
