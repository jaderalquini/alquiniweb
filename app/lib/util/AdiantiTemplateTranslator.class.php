...
class AdiantiTemplateTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['pt'][] = 'Digite os código de 6 dígitos a partir de seu aplicativo autenticador';
        ...
        $this->messages['es'][] = 'Ingrese el código de 6 dígitos de su aplicación de autenticación';
